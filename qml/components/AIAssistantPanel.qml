                            ...
                            Rectangle {
                                ...
                                Column {
                                    ...
                                    Text {
                                        ...
                                        text: "입력 소스: " + (root.currentDocumentSourceMode === "external_file"

                                            ? (root.currentExternalDocumentType === "external_folder" ? "외부 폴더 1개" : "외부 파일 1개")
                                    ...
                                    Text {
                                        ...
                                        visible: root.currentDocumentSourceMode === "external_file"

                                        text: root.currentExternalDocumentTitle !== "" ? root.currentExternalDocumentTitle : (root.currentExternalDocumentPath !== "" ? root.currentExternalDocumentPath : (root.currentExternalDocumentType === "external_folder" ? "외부 폴더가 선택되지 않았습니다." : "외부 파일이 선택되지 않았습니다."))
                                    ...
                                    Text {
                                        ...
                                        visible: root.currentDocumentSourceMode === "external_file" && root.currentExternalDocumentType === "external_folder" && root.currentExternalDocumentSelectedCount > 0

                                        text: "폴더 문서 처리: " + root.currentExternalDocumentProcessedCount + " / " + root.currentExternalDocumentSelectedCount + " (지원 파일 총 " + root.currentExternalDocumentTotalSupportedCount + ")"
